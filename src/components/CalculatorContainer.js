...
const CalculatorContainer = ({ mode, handleClick, states, handleSubmit }) => {
  return (
    <div className="flex flex-col items-center justify-center md:justify-evenly bg-foreground-blue dark:bg-darker-purple w-container h-container my-10 rounded-calc md:w-container-large md:h-container-large md:p-5">
